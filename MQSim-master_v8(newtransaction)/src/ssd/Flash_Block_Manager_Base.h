...
#define All_VALID_PAGE 0x0000000000000000ULL
	...
	*/
	...
	struct Blk_meta {
		...
		flash_chip_ID_type ChipID;
		flash_die_ID_type DieID;
		flash_plane_ID_type PlaneID;
		flash_block_ID_type BlockID;
	};
	static std::vector< Block_Pool_Slot_Type*> Blocks_Turbo;
	static std::vector< Blk_meta> Blocks_Turbo_M; //M -> meta
	static std::vector< NVM::FlashMemory::Physical_Page_Address*> Blocks_Turbo_meta;
	...
	public:
		...
		Block_Pool_Slot_Type* Get_a_free_block(stream_id_type stream_id, bool for_mapping_data, NVM::FlashMemory::Physical_Page_Address* page_address);
#elif BASELINE
